# R10: API endpoint security list — the public OKE control-plane endpoint.
# Allows worker/pod/bastion/external access to the Kubernetes API (6443) and
# the OKE-managed control-plane port (12250), plus path-discovery ICMP.
